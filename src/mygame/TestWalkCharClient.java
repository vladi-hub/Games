 ...
 * @author ches
 */
public class TestWalkCharClient extends SimpleApplication implements ActionListener, PhysicsCollisionListener, AnimEventListener {
    public static void main(String... args) {
        TestWalkCharClient app = new TestWalkCharClient();
